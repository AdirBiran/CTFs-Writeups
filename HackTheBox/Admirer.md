...
db name is admirerdb
mariadb 10.1.41

tar the html.tar.gz file:
...
an interesting comment about other open source implementation.
...
after seeing the comment about open source implementation, 
search google lead to adminer (previously phpminadmin) and its login page.
...
tried all the credentials retrieved so far, nothing worked tho.
<p align="center">
...
looking further for technical details for that arbirary file read in adminer 4.6.2,
found this article
https://podalirius.net/en/cves/2021-xxxxx/

for that exploit to work, we need to create a sql db on our local machine, connect to it from the adminer's login page and read files on the server.
...
allow access from the amirer machine:
<p align="center">
...
then, read the content of index.php by selecting getfile table:
SELECT * FROM getfile;
<p align="center">
...
we found another password for waldo:
waldo:&<h5b~yK3F#{PaPB&dA}{H>

sshing the machine with those credentials worked.
<p align="center">
...
lets see what's inside this directory.
<p align="center">
